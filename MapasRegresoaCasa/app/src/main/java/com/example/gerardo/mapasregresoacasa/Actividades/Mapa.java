...
import com.example.gerardo.mapasregresoacasa.BuscarDireccion;
import com.example.gerardo.mapasregresoacasa.DirectionFinderListener;
...
import com.example.gerardo.mapasregresoacasa.Route;
import com.example.gerardo.mapasregresoacasa.UbicacionActual;
        ...
        btnguardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(txtorigen.getText().toString().trim().length()>0 && txtdestino.getText().toString().trim().length() > 0 ) {
                    ...
                    Toast.makeText(getBaseContext(), "Ruta Guardada", Toast.LENGTH_SHORT).show();
                }
